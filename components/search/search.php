...
<div class="c-search">
    ...
    <form class="c-search__form c-form" aria-label="<?php echo lang('searchAriaLabel'); ?>" role="search" method="GET"
        action="<?php echo SITE ?>/catalog">

        <input type="search" autocomplete="off" aria-label="<?php echo lang('searchPh'); ?>" name="search"
